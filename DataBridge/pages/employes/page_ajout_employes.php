    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="card shadow p-4 rounded-3">
                ...
                <form action="page_ajout_employes.php" method="post" id="employeForm">
                    <!-- Champ Nom -->
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control" id="telephone" name="telephone" placeholder="5432" pattern="^[0-9]{4}$" maxlength="4" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="login" name="login" placeholder="Entrez un login" maxlength="25" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control" id="motDePasse" name="motDePasse" placeholder="Entrez un mot de passe" required oninput="verifierMotDePasseEnDirect()">
                    ...
                    <div class="text-center position-relative">
                        <button type="submit" id="submitBtn" class="btn btn-primary fw-bold px-4" disabled>
                            <i class="fas fa-save"></i>&nbsp;&nbsp;Enregistrer
                        </button>
                    </div>
                </form>
                    <!-- Bouton Annuler en dehors du formulaire principal -->
                <form method="post" action="page_employes.php?page=1" id="employeFormSupp">
...
<div class="modal fade" id="deleteKoModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                L'insertion de l'employé a échoué.<br>Veuillez réessayer.<br>Veuillez vérifier les homonymes.
            </div>
            <div class="modal-footer">
