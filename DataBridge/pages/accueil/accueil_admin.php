...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">
    ...
    <div class="offcanvas-body">
        <ul class="list-unstyled">
            <!-- Bouton pour rediriger vers l'accueil -->
            <li>
            ...
            <!-- Dépliant pour rediriger vers la gestion des employés -->
            <li>
                ...
                <ul class="submenu">
                    <li><a href="../employes/page_ajout_employes.php" class="text-decoration-none">Ajouter un employes</a></li>
                    <li><a href="../employes/page_employes.php?page=1" class="text-decoration-none">Consulter les employes</a></li>
                </ul>
            </li>
            <!-- Dépliant pour rediriger vers la gestion des conférenciers -->
            <li>
                <a class="text-decoration-none d-flex justify-content-between align-items-center">
            ...
            <!-- Dépliant pour rediriger vers la gestion des exspotions -->
            <li>
                <a class="text-decoration-none d-flex justify-content-between align-items-center">
            ...
            <!-- Dépliant pour rediriger vers la gestion des visites -->
            <li>
                <a class="text-decoration-none d-flex justify-content-between align-items-center">
                    Gestion des Visites
                    <i class="submenu-icon fa fa-chevron-right"></i>
...
<div class="container text-center mt-5">
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4">
        <!-- Gestion des Comptes Employés -->
        <div class="col">
            <a href="../employes/page_employes.php?page=1"  class="text-decoration-none">
        ...
        <!-- Gestion des Conférenciers -->
        <div class="col">
            <a href="../conferenciers/page_conferenciers.php?page=1" class="text-decoration-none">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body bg-primary text-white rounded">
        ...
        <!-- Gestion des Expositions -->
        <div class="col">
            <a href="../expositions/page_expositions.php?page=1" class="text-decoration-none">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body bg-primary text-white rounded">
        ...
        <!-- Gestion des Visites -->
        <div class="col">
            <a href="../visites/page_visites.php?page=1" class="text-decoration-none">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-body bg-primary text-white rounded">
