...
<nav class="navbar navbar-transparent fixed-top">
    <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <div class="text-center">
            <span class="me-3 mt-3 text-white"><?php echo ($_SESSION['loginEmploye']);?></span><br>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">
    ...
    <div class="offcanvas-body">
        <ul class="list-unstyled">
            ...
            <li>
                <a href="accueil_employe.php" class="text-decoration-none d-flex justify-content-between align-items-center">
                    Accueil
            ...
            <!-- Dépliant pour rediriger vers la gestion des expositions -->
            <li>
                <a class="text-decoration-none d-flex justify-content-between align-items-center">
...
<div class="container text-center mt-5">
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4 d-flex justify-content-between align-items-center">
        <!-- Gestion des Conférenciers -->
        <div class="col">
