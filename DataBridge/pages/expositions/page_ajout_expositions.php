...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $intituleExpo = htmlspecialchars($intituleExpo);
    ...
    $intituleExpo = htmlentities($intituleExpo, ENT_QUOTES);
    ...
    <div class="offcanvas-body">
        <ul class="list-unstyled">
            ...
            <li>
                ...
                <ul class="submenu">
                    <li><a href="../exposition/page_ajout_expositions.php" class="text-decoration-none">Ajouter une Exposition</a></li>
            ...
            <div class="card shadow p-4 rounded-3">
                ...
                <form method="post" action="page_ajout_expositions.php" id="expositionForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="intitule" name="intitule" placeholder="Entrez l'intitulé" maxlength="100" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="resume" name="resume" placeholder="Entrez le Résumé" maxlength="250" required>
                    </div>
                ...
                <form method="post" action="../expositions/page_expositions.php?page=1" id="expositionFormSupp">
