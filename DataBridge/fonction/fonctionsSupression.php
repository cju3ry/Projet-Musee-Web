...
function suppressionExposition($pdo, $idExposition) {
    ...
    //INSERT INTO `exposition` (`idExposition`, `intitule`, `periodeDebut`, `periodeFin`, `nombreOeuvres`, `resume`,`debutExpoTemp`, `finExpoTemp`) VALUES('E0000010', 'Les paysages impressionnistes', 1880, 1895, 20
    // ,'Trèsbelleexposition mettant en évidence les approches différentes de grands peintres du mouvementimpressionniste','2024-11-05', '2024-12-14');
   // INSERT INTO `motsCle` (`idMotCle`, `motCle`, `idExposition`) VALUES (26, 'paysage', 'E0000010')
}
